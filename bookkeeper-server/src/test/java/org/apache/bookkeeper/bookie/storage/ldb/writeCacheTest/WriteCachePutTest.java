...
public class WriteCachePutTest extends TestCase {
    ...
    private  static final int invalidSize = 10;
    WriteCache cache;

    public WriteCachePutTest(long ledgerId, long entryId, ByteBuf entry, boolean expected) {
        configure(ledgerId, entryId, entry, expected);
    }

   private void configure(long ledgerId, long entryId, ByteBuf entry, boolean expected){
